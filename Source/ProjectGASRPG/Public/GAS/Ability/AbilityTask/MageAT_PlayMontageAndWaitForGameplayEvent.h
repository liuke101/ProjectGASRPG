...
#include "MageAT_PlayMontageAndWaitForGameplayEvent.generated.h"
 ...
 */
UCLASS()
class PROJECTGASRPG_API UMageAT_PlayMontageAndWaitForGameplayEvent : public UAbilityTask
{
	GENERATED_BODY()
...
public:
	...
	static UMageAT_PlayMontageAndWaitForGameplayEvent* PlayMontageAndWaitForGameplayEvent(
