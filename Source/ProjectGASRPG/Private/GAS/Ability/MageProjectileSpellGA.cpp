...
void UMageProjectileSpellGA::SpawnProjectile(const FVector& TargetLocation)
{
	...
	if(ICombatInterface* CombatInterface = Cast<ICombatInterface>(GetAvatarActorFromActorInfo()))
	{
		...
		const FVector WeaponSocketLocation = CombatInterface->Execute_GetWeaponSocketLocationByMontageTag(GetAvatarActorFromActorInfo(), FMageGameplayTags::Get().Montage_Attack_Weapon);
