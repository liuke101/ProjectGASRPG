...
void FMageGameplayTags::InitNativeGameplayTags()
{
   ...
   TagsInstance.Player_Block_InputPressed = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Player.Block.InputPressed"),FString("阻止InputPressed"));
	...
	TagsInstance.Input_Ctrl = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Input.Ctrl"),FString("Ctrl键"));
	...
	TagsInstance.Ability_Mage_Ice_IceBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Ability.Mage.Ice.IceBlast"),FString("法师-冰-冰爆术"));
	TagsInstance.Cooldown_Mage_Ice_IceBlast = UGameplayTagsManager::Get().AddNativeGameplayTag(FName("Cooldown.Mage.Ice.IceBlast"),FString("法师-冰-冰爆术冷却"));
