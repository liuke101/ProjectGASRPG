...
class SExtBuildProgressWidget;

/**
 * A FFeedbackContext implementation for use in UnrealEd.
 */
class FExtFeedbackContextEditor : public FFeedbackContext
{
	...
	TSharedPtr<class SExtBuildProgressWidget> BuildProgressWidget;

	bool HasTaskBeenCancelled;

public:

	FExtFeedbackContextEditor();
