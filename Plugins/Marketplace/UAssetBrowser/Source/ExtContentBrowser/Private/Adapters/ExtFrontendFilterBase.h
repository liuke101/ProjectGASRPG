...
class FExtFrontendFilterCategory
{
public:
	FExtFrontendFilterCategory(const FText& InTitle, const FText& InTooltip) : Title(InTitle), Tooltip(InTooltip) {}
...
class FExtFrontendFilter : public IFilter<FExtAssetFilterType>
{
public:
	FExtFrontendFilter(TSharedPtr<FExtFrontendFilterCategory> InCategory) : FilterCategory(InCategory) {}
	...
	DECLARE_DERIVED_EVENT( FExtFrontendFilter, IFilter<FExtAssetFilterType>::FChangedEvent, FChangedEvent );
	virtual FChangedEvent& OnChanged() override { return ChangedEvent; }

	TSharedPtr<FExtFrontendFilterCategory> GetCategory() { return FilterCategory; }
...
private:
	...
	TSharedPtr<FExtFrontendFilterCategory> FilterCategory;
};
