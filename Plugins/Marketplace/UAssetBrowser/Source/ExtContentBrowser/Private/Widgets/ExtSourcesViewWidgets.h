...
class SExtAssetTreeItem : public SCompoundWidget
{
public:
	...
	SLATE_BEGIN_ARGS( SExtAssetTreeItem )
...
private:
	...
	/** Returns the text of the current loading folder name */
...
private:
	...
	const FSlateBrush* FolderClosedProjectBrush;
	const FSlateBrush* FolderOpenProjectBrush;
	const FSlateBrush* FolderClosedVaultCacheBrush;
	const FSlateBrush* FolderOpenVaultCacheBrush;
	...
	EVisibility GetFolderIconVisibility() const;

	FSlateColor GetTreeItemColor() const;	
};
