...
class SContentBrowserPathPicker : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SContentBrowserPathPicker)
...
private:
	...
	bool ISContentBrowserPathPickerEnabled() const;

private:
	static FString LastAssetPath;
