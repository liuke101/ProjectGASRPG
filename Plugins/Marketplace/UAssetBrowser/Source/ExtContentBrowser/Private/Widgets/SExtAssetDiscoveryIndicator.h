...
class SExtAssetDiscoveryIndicator : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS( SExtAssetDiscoveryIndicator )
	...
	/** Destructor */
	virtual ~SExtAssetDiscoveryIndicator();
	...
	void OnAssetRegistryFileLoadProgress(const FExtAssetRegistry::FAssetGatherProgressUpdateData& ProgressUpdateData);
